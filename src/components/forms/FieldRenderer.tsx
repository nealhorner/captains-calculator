  ...
  return (
    <React.Fragment>
      {Object.keys(formConfig.fields).map((fieldId, key) => {
        ...
        let isFieldEditable =
          formMode === 'create' ? true : formConfig.editable.indexOf(fieldId) > -1;
        ...
        const renderInput = () => {
          switch (fieldSchema.type) {
            ...
            case 'zip':
              return (
                <NumberInput
                  ...
                  value={
                    typeof values[formFieldId] !== 'undefined' &&
                    values[formFieldId] !== null &&
                    values[formFieldId].length
                      ? parseInt(values[formFieldId])
                      : values[formFieldId]
                  }
                  error={errors[formFieldId]}
                  required={isFieldRequired}
            ...
            case 'date-picker':
              ...
              let dateValue = isSet
                ? rawDate
                : typeof values[formFieldId] === 'object'
                  ? values[formFieldId]
                  : null;
              return (
                <DatePicker
