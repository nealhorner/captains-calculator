      ...
      <MantineProvider
        ...
        styles={{
          Modal: (theme) => ({
            modal: {
              backgroundColor:
                theme.colorScheme === 'light' ? theme.colors.gray[2] : theme.colors.dark[7],
            },
          }),
          Drawer: (theme) => ({
            drawer: {
          ...
          <Global
            styles={(theme) => ({
              ...
              'input:-webkit-autofill': {
                color:
                  theme.colorScheme === 'dark' ? theme.colors.dark[3] + ' !important' : theme.black,
                WebkitTextFillColor:
                  theme.colorScheme === 'dark' ? theme.colors.dark[0] + ' !important' : theme.black,
