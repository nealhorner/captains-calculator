...
const Buildings: React.FC = () => {
  ...
  const { currentItemId: currentCategoryId, currentItem: currentCategory } = useAppState(
  ...
  return (
    <PageLayout header={<PageHeader title={`Buildings & Machines`} />}>
